...
# required in sbmt/pact due to deep_dup and blank methods
...
def pact_broker
  has_http_pact_between 'Pact Broker Client Ffi', 'Pact Broker', opts: {
    pact_dir: "spec/pacts",
    log_level: :info,
    mock_port: 9999
  }
...
def pactflow
  has_http_pact_between 'Pact Broker Client Ffi', 'PactFlow', opts: {
    pact_dir: "spec/pacts",
    log_level: :debug,
    mock_port: 9998
  }
